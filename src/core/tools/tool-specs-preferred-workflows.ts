        ...
        },
{
            ...
            description:
                "PREFERRED first call for unfamiliar symbol changes. Returns a compact packet with one confirmed definition, ranked impacted files, edit-risk signals, next reads, and limitations. Use mode:'standard' only when raw AST/graph/provenance evidence is needed. Do not manually chain search/definition/reference primitives unless this result is insufficient.",
            category: 'workflow',
            inputSchema: {
                type: 'object',
                properties: {
                    ...
                    mode: {
                        ...
                        default: 'compact',
                        description: 'Compact decision packet by default; standard/debug include raw backend evidence.',
                    },
