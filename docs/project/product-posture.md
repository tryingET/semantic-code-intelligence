...
- graph-impact dogfood characterizes TypeScript, Python, Rust, Go, symbol-seed, and unsupported-extension graph evidence with explicit backend provenance and syntactic/fallback limitations;
