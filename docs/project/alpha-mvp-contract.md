...
| `explore_symbol_impact` | Preferred renamed impact workflow for bounded definition/reference/graph-impact inspection around a symbol and optional file context. | Definitions, references, graph/impact evidence, limits/fallback status, and planning hints suitable for check recommendation. |
